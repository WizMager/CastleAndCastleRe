...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public void Execute()
		{
			...
			var duplicateBoneChecker = new NativeHashSet<Hash128>(data.rigBones.Length, Allocator.Temp);
			...
			for (int l = 0; l < bonesArr.Length; ++l)
			{
				...
				if (!duplicateBoneChecker.Add(db.hash))
					Debug.LogError($"RigDefinitionBaker: Duplicate bone with name '{db.name}' in rig! This is not allowed!");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public void Execute(int startIndex, int count)
		{
			for (int i = startIndex; i < startIndex + count; ++i)
			{
				...
				if (rd.hasAnimationEvents)
				{
					ecb.AddBuffer<AnimationEventComponent>(startIndex, e);
					ecb.AddBuffer<PreviousProcessedAnimationComponent>(startIndex, e);
				}
			}
		}
	}
