...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		void AddAnimationClipBlob(RTP.AnimationClip ac, ref BlobBuilder bb, ref AnimationClipBlob acb)
		{
			...
			AddAnimationEvents(ac, ref bb, ref acb);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		void AddAnimationEvents(RTP.AnimationClip ac, ref BlobBuilder bb, ref AnimationClipBlob acb)
		{
			var eventsArr = bb.Allocate(ref acb.events, ac.events.Length);
			for (var i = 0; i < eventsArr.Length; ++i)
			{
				var inData = ac.events[i];
				ref var evt = ref eventsArr[i];
				evt.time = inData.time / ac.length;
				evt.floatParam = inData.floatParam;
				evt.intParam = inData.intParam;
				
				if (inData.name.Length > 0)
				{
					evt.nameHash = inData.name.CalculateHash32();
				#if RUKHANKA_DEBUG_INFO
					bb.AllocateString(ref evt.name, ref inData.name);
				#endif
				}
				
				if (inData.stringParam.Length > 0)
				{
					evt.stringParamHash = inData.stringParam.CalculateHash32();
				#if RUKHANKA_DEBUG_INFO
					bb.AllocateString(ref evt.stringParam, ref inData.stringParam);
				#endif
				}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public void Execute(int startIndex, int count)
		{
			for (int i = startIndex; i < startIndex + count; ++i)
			{
				...
				if (bd.hasEvents)
					ecb.AddBuffer<AnimatorControllerEventComponent>(startIndex, e);
