...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public override void Bake(RigDefinitionAuthoring a)
	{
		...
		var acbd = new RigDefinitionBakerComponent
		{
			...
			hasAnimationEvents = a.hasAnimationEvents,
		#if RUKHANKA_DEBUG_INFO
			name = a.name
		#endif
		};
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	RTP.RigBoneInfo CreateRigBoneInfo(RigDefinitionAuthoring rda, List<InternalSkeletonBone> skeletonBones, Avatar avatar, int boneIndex)
	{
		...
		if (rda.boneEntityStrippingMode == RigDefinitionAuthoring.BoneEntityStrippingMode.Manual && !boneIsObjectRoot)
		...
		var ab = new RTP.RigBoneInfo()
		{
			...
			refPose = pose,
			boneObjectEntity = GetEntityForBone(t, boneTransformFlags, rda.boneEntityStrippingMode == RigDefinitionAuthoring.BoneEntityStrippingMode.Automatic),
