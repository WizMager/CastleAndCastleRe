...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	static void BakeAnimationEvents(ref RTP.AnimationClip rv, AnimationClip ac)
	{
		if (ac.events.Length == 0)
			return;

		rv.events = new (0xf, Allocator.Persistent);
		foreach (var ae in ac.events)
		{
			var bakedEvent = new RTP.AnimationEvent()
			{
				name = ae.functionName,
				time = ae.time,
				floatParam = ae.floatParameter,
				intParam = ae.intParameter,
				stringParam = ae.stringParameter,
			};
			rv.events.Add(bakedEvent);
		}
	}
