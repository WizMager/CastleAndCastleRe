...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
	{
		...
		while (cee.NextEntityIndex(out var i))
		{
			...
			ExecuteSingle(layers, parameters, ref controllerEventsBuffer);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void ExecuteSingle(DynamicBuffer<AnimatorControllerLayerComponent> aclc, NativeArray<AnimatorControllerParameterComponent> acpc, ref DynamicBuffer<AnimatorControllerEventComponent> events)
	{
		if (events.IsCreated)
			events.Clear();
		...
		for (int i = 0; i < aclc.Length; ++i)
		{
			...
			ProcessLayer(ref acc.controller.Value, acc.layerIndex, acpc, dt, ref acc, ref events);
			if (events.IsCreated)
			{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	)
	{
		...
		EnterTransition(ref acc, ref layer, runtimeParams, srcStateDurationFrameDelta, curStateDuration, ref events);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	float CalculateMotionDuration(ref MotionBlob mb, in NativeArray<AnimatorControllerParameterComponent> runtimeParams, float weight)
	{
